...
<div class="row order-detail-page">
	<div class="small-12 columns">
		<h2><?php _e( 'Order Details',THB_THEME_NAME ); ?></h2>
	...
	<div class="small-12 columns">
		<h2><?php _e( 'Customer details',THB_THEME_NAME ); ?></h2>
		<div class="row">
			...
			<div class="small-12 medium-6 columns">
				...
				<?php endif; ?>
						...
						<label><?php _e( 'Billing Address',THB_THEME_NAME ); ?></label>
						<address><p>
							<?php
				...
				<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
					...
					<div class="small-6 columns address">
						...
						<label><?php _e( 'Shipping Address',THB_THEME_NAME ); ?></label>
						<address><p>
							<?php
