...
<div id="shortcode-generator">
	...
	<div class="shortcode-content">
		...
		<div class="content"><select id="thb-shortcodes" data-placeholder="' . __("Choose a shortcode", THB_THEME_NAME) .'">
	    <option></option>';
...
<?php echo $shortcode_html . $html_options;  ?>
	...
	<a class="thb-btn" id="add-shortcode"><?php echo __( 'Add Shortcode', THB_THEME_NAME ); ?></a>
