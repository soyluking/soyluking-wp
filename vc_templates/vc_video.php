...
$css_class =  apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'flex-video widescreen vimeo wpb_video_widget wpb_content_element'.$el_class, $this->settings['base']);
